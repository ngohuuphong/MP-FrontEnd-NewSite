                ...
                foreach ($arr as $value){
                    ...
                    switch ($value) {
                        case 1:
                            ...
                            $_answers = 'アプローチを受けて見送る場合の不採用通知は不要です。選考通過後の不採用通知はご対応をお願いいたします。';
                            break;
                        case 2:
                        ...
                        case 3:
                            ...
                            $_answers = 'サイト内のオファーメールでやり取りをお願いいたします。ただし、オファーメールから説明会に参加した学生に関しては、双方Ｅメールや電話で連絡を希望する場合、直接やり取りしていただいても構いません。';
                            break;
                        case 4:
                            $_question = '学生の性格タグは何を表していますか。';
                            $_answers = '学生が企業様にアピールしたい自身の強み・性格です。適性検査などによる診断結果ではありません。';
                            break;
                        case 5:
                        ...
                        case 8:
                            ...
                            $_answers = '弊社サービスは完全成功報酬型です。学生が内定承諾をした段階で紹介料が発生いたします。入社前に辞退が発生した場合は全額ご返金、入社後3ヶ月以内迄は返金制度を設けております。詳細はご提案書・契約書をご確認ください。';
                            break;
                        case 9:
